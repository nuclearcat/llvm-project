...
void call_umask(mode_t runtime_mode) {
  ...
  umask(7777);    // expected-warning {{'umask' argument has bits outside 0777 (017000); those bits are ignored}}
  umask(-1);      // expected-warning {{'umask' argument has bits outside 0777 (}}
